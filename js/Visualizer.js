...
class Visualizer {
    ...
    resize() {
        if (this.waveformSvg) {
            ...
            this.svgWidth = (node && node.clientWidth) || window.innerWidth;
            this.svgHeight = (node && node.clientHeight) || window.innerHeight;
            ...
            // Cache barWidth during resize for optimized update cycles
