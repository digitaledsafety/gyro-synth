...
class AudioEngine {
    ...
    updateEnvelopeProperty(property, value) {
        ...
        updateSynthEnv(this.instrument);
        if (this.previewLoop) updateSynthEnv(this.previewLoop.synth);
        this.savedLoops.forEach(loop => updateSynthEnv(loop.synth));
    }
